...
public class SysConfig extends AbstractConfig {
	...
	public SysConfig(String myRootDir) {
		...
		doSetValue(SysConfig.DB_CONNECTION, "jdbc:postgresql://localhost:5432/tabirta");
		doSetValue(SysConfig.DB_USER, "tabirta");
		doSetValue(SysConfig.DB_PASSWORD, "Rg1QSedjppQ7LJ8T");
	}
